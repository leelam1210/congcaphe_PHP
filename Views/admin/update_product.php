        ...
        <div class="form-tour">
            <form action="" method="post" enctype="multipart/form-data" id="form-update-product">
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="<?php echo isset($product) ? $product->name : ''?>" id="" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="price" id="" value="<?php echo isset($product) ? $product->price : ''?>" class="form-control">
                </div>
                <div class="form-row">
                    <div class="form-group col-xl-4">
                        ...
                        <div class="preview-form-image-2 img">
                            <img style="max-height: 250px; width: auto; max-width: 340px" src="<?php echo Helpers::showImage($product->image) ?>"  alt="">
                        </div>
                    </div>
                    <div class="form-group col-xl-8">
                        <label for="inputDescription">Nội dung chính</label>
                        <textarea class="form-control" cols="" rows="12" name="content" id="inputDescription"><?php echo isset($product) ? nl2br($product->name) : ''?></textarea>
                    </div>
                </div>

                <button class="btn bg-orange">Cập nhật sản phẩm</button>
            </form>
        </div>
    </div>
</main>
